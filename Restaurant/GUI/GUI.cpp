...
void GUI::PrintMessage(string msg, bool Clear_Status, double Num) const	//Prints a message on status bar
{
	if (Num == 0)
	{
	...
	if ( Clear_Status && Num == 1.03)
	{
		ClearStatusBar();
		pWind->SetPen(DARKRED);
		pWind->SetFont(18, BOLD , BY_NAME, "Arial");

		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight/1.01), msg); 
	return;	
	}
	if(Num == 1.03)
		ClearStatusBar();	
	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD , BY_NAME, "Arial");
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight/Num), msg); 
}
//////////////////////////////////////////////////////////////////////////////////////////
...
PROG_MODE	GUI::getGUIMode() const
{
	...
	do
	{
		PrintMessage("Please select GUI mode: (1)Interactive, (2)StepByStep, (3)Silent ... ",true,1.03);
		string S = GetString();
